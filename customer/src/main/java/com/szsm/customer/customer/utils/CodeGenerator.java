...
//                            .fileOverride()
                            .outputDir("D:\\record\\nb-poc\\marketing\\customer\\src\\main\\java"); // 指定输出目录
                })
                .packageConfig(builder -> {
                    builder.parent("com.szsm.customer.customer") // 设置父包名
                            .moduleName(null) // 设置父包模块名
                            .pathInfo(Collections.singletonMap(OutputFile.xml, "D:\\record\\nb-poc\\marketing\\customer\\src\\main\\resources\\mappers")); // 设置mapperXml生成路径
                })
